...
class RpcConsumeCommand extends WorkCommand
{
    protected $signature = 'rabbitmq:rpc-consume
                            {connection? : The name of the queue connection to work}
                            {--name=default : The name of the consumer}
                            {--queue=tasks_reply_queue : The names of the queues to work}
